...
ThisBuild / homepage := Some(url("https://github.com/accur8/locus"))
ThisBuild / scmInfo := Some(ScmInfo(url("https://github.com/accur8/locus"), "scm:git@github.com:accur8/locus.git"))
